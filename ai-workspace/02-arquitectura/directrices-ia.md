...
3. **Cada sesión deja rastro** en `../03-proceso/sesiones/`: prompt de partida, qué se generó, **qué se rechazó y por qué**. Lo tercero es lo que tiene valor; lo primero es contexto.
