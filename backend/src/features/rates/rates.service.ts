...
export class RatesService {
  ...
  async get(): Promise<RatesView> {
    ...
    try {
      ...
      // La API fallo. Si hay algo cacheado, se sirve MARCADO: sigue siendo un 200 y no un
      // 503 porque los datos son utilizables -un tipo de ayer orienta perfectamente- y la
      // decision de mostrarlos es de la UI, que pinta "Tipos de cambio del {fecha}". Un
      // 503 haria que el frontend descartara datos que si valen.
      //
